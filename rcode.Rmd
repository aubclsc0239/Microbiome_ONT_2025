...
cbbPalette <- c("#56B4E9", "#8C6D3B", "#E69F00", "#008000", "#000000", 
                "#D55E00", "#009E73", "#CC79A7", "#F1A7B6", "#1F77B4", 
                "#8C564B", "#2CA02C", "#FF7F0E", "#9467BD", "#E69F00", "#D55E00")
```
...
scores.time$Time <- meta.day90.time$Time
...
# Control vs BM
res.bm = results(diagdds, contrast = c("Treatments", "BM", "Control"), cooksCutoff = FALSE)
resultsNames(diagdds)
res.bm.shrunk <- lfcShrink(diagdds, coef = "Treatments_BM_vs_Control", type = "apeglm")
...
# Control vs HSB.BM
res.hsb.bm = results(diagdds, contrast = c("Treatments", "HSB+BM", "Control"), cooksCutoff = FALSE)
res.hsb.bm.shrunk <- lfcShrink(diagdds, coef = "Treatments_HSB.BM_vs_Control", type = "apeglm")
...
# Control vs BM
res.bm.60 = results(diagdds.60, contrast = c("Treatments", "BM", "Control"), cooksCutoff = FALSE)
res.bm.60.shrunk <- lfcShrink(diagdds.60, coef = "Treatments_BM_vs_Control", type = "apeglm")
...
# Control vs HSB.BM
res.hsb.bm.60 = results(diagdds.60, contrast = c("Treatments", "HSB+BM", "Control"), cooksCutoff = FALSE)
res.hsb.bm.60.shrunk <- lfcShrink(diagdds.60, coef = "Treatments_HSB.BM_vs_Control", type = "apeglm")
...
# Control vs BM
res.bm.90 = results(diagdds.90, contrast = c("Treatments", "BM", "Control"), cooksCutoff = FALSE)
res.bm.90.shrunk <- lfcShrink(diagdds.90, coef = "Treatments_BM_vs_Control", type = "apeglm")
...
# Control vs HSB.BM
res.hsb.bm.90 = results(diagdds.90, contrast = c("Treatments", "HSB+BM", "Control"), cooksCutoff = FALSE)
res.hsb.bm.90.shrunk <- lfcShrink(diagdds.90, coef = "Treatments_HSB.BM_vs_Control", type = "apeglm")
head(res.hsb.90.shrunk)
...
ggsave("Plots/DeseqFig.tiff", plot = DeseqFig, dpi=300, width = 33, height = 12, units = "cm")
