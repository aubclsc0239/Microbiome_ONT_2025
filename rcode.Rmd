...
cbbPalette <- c("#000080", "#8C6D3B", "#8B0000", "#008000", "#000000", 
...
AlphaFig2.wfhw <- ggarrange(richness.treatment.time, 
                     even.treatment.time,
                     labels = c("b","c"), 
                     nrow = 1, ncol = 2, 
                     common.legend = TRUE,
...
AbunFig.wfhw <- ggarrange(rel_abun_treatment, 
                     labels = "a",
                     font.label = list(size = 16, face = "bold", color = "black"))
...
ggsave("Plots/AlphaFig2.wfhw.tiff", plot = AlphaFig2.wfhw, dpi=300, width = 27, height = 9, units = "cm")
ggsave("Plots/AbunFig.wfhw.tiff", plot = AbunFig.wfhw, dpi = 300, width = 35, height = 12, units = "cm")
